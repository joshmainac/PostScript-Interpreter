...
#this is my additional test    

testinput9 = """
    true {1 1 add} if stack
    """

testinput10 = """
    2 {1 1 add} repeat stack

    """

testinput11 = """
    true {true {true {3 3 add} if} if} if stack
...
#test10
# (venv) D:\2021fall\CPT355\HW5>repl.py --static
# <ssps> 2 {1 1 add} repeat stack
# [Literal(2), Block([Literal(1), Literal(1), Name('add')]), Name('repeat')]
# <ssps> stack
# [Name('stack')]
# ===**opstack**===
# 2
...
# (venv) D:\2021fall\CPT355\HW5>repl.py
# <ssps>  2 {1 1 add} repeat
# [Literal(2), Block([Literal(1), Literal(1), Name('add')]), Name('repeat')]
# <ssps> stack
# [Name('stack')]
# ===**opstack**===
...
#test11
# (venv) D:\2021fall\CPT355\HW5>repl.py --static
# <ssps> true {true {true {3 3 add} if} if} if
# [Literal(True), Block([Literal(True), Block([Literal(True), Block([Literal(3), Literal(3), Name('add')]), Name('if')]), Name('if')]), Name('if')]
# <ssps> stack
# [Name('stack')]  
# ===**opstack**===
# 6
